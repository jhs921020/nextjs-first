    ...
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.content}>
          ...
          repellat, libero rem rerum provident aspernatur quas perferendis
          blanditiis quae quisquam deleniti mollitia iste eos veritatis animi
          nemo? Commodi, voluptatibus?
        </div>
      </div>
    </div>
  );
